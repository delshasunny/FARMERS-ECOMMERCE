<footer class="page-footer">
		...
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--whybuy">
				...
				<ul class="footer-nav__list">
					...
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Farmers</a>
					</li>
					<li class="footer-nav__item">
            ...
            Mammiyoor, kerala
				...
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">support@lfcollege.com</a>
				</div>
			</div>
	...
	<!-- <div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>Farmers</span><br> Fashion awards 2016
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2018 Farmers Ecommerce&trade;
			</div>

			<div class="developer">
				LF College Mammiyoor
			</div>
