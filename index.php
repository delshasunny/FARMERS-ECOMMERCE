  ...
  <footer class="page-footer">
      ...
      <div class="container clearfix">
        ...
        <div class="footer-nav__col footer-nav__col--info">
          ...
          <ul class="footer-nav__list">
            <li class="footer-nav__item">
              <a href="#" class="footer-nav__link">The Store</a>
            </li>
            <li class="footer-nav__item">
        ...
        <div class="footer-nav__col footer-nav__col--account">
          ...
          <ul class="footer-nav__list">
            ...
            <li class="footer-nav__item">
              <a href="cart.php" alt="Please login"  class="footer-nav__link">Update information</a>
            </li>
          </ul>
        </div>
        ...
        <div class="footer-nav__col footer-nav__col--contacts">
          ...
          <div class="email">
            Email:
            <a href="mailto:support@lfcollege.com" class="email__addr">support@lfcollege.com</a>
          </div>
        </div>
    ...
    <!-- <div class="banners">
        <div class="container clearfix">
          ...
          <div class="banner-award">
            <span>Farmers Ecommerce</span><br> Farmers
          </div>
    ...
    <div class="page-footer__subline">
      <div class="container clearfix">
        ...
        <div class="copyright">
          &copy;
          <?php echo date("Y"); ?> Farmers E-Commerce&trade;
        </div>

        <div class="developer">
          Design by LF College
        </div>
