...
function getPro()
{
  ...
  $get_products = "select * from products where stock > 1 order by 1 DESC LIMIT 0,8";
...
function getProducts()
{
  ...
  $sWhere = (count($aWhere) > 0 ? ' WHERE stock > 0 and ' . implode(' or ', $aWhere) : '  WHERE stock > 0 ') . $sLimit;
